...
// ✅ GLOBAL URL DEFINITION (Backend URL)
...
const AdminDashboard = ({ user, onLogout }) => {
  ...
  const fetchDashboardData = async () => {
    try {
      // ✅ FIXED: Template Literals (Backticks) for API requests
        ...
        <div className="content-body">
                 ...
                 <div className="content-split">
                    ...
                    <div className="card-box map-box">
                       ...
                       <div className="map-wrapper-small">
                          {/* ✅ Using Key to force refresh map when adminEmail changes */}
                          {DeliveryMap ? <DeliveryMap key={user.email} adminEmail={user.email} /> : <Placeholder title="Map" />}
                       </div>
                    </div>
                 </div>
              </div>
            ...
            {activeMenu === 'MapView' && (
               <div className="full-map-container">
                  {DeliveryMap ? <DeliveryMap key="full-map" adminEmail={user.email} /> : <Placeholder title="Map" />}
               </div>
            )}
        </div>
      </main>
